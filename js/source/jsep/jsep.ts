...
export class Jsep {
    ...
    gobbleBinaryExpression(): jsep.Expression | false {
        let node: Expression, biop: string, prec, biop_info, left, right, i, cur_biop;
        ...
        const stack: (BiOp | Expression)[] = [left as Expression, biop_info, right as Expression];
        ...
        while ((biopStart = this.gobbleBinaryOp())) {
            ...
            node = this.gobbleToken() as Expression;
            ...
            while (tc_len > 0) {
                ...
                if (to_check in Jsep.unary_ops && (
                    ...
                    return {
                        ...
                        prefix: true} as UnaryExpression;
                }
...
function gobbleTernary(this: Jsep, env: { context: Jsep, node: Expression }): Expression {
